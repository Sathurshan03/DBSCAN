...
function [track1, track2, track3, sensorsData, cluster1, cluster2, cluster3, centr1, centr2, centr3] = fcn(frontCamDets, frontLeftRadarDetsInfo, frontRightRadarDetsInfo, lidarPointCloudInfo, clockTime)    
    ...
    radius = 0.25;
    minPoints = 3;
    [leftOverData, track1, track2, track3, cluster1, cluster2, cluster3, centr1, centr2, centr3] = DBSCAN(radius, minPoints, sensorsData);
end
...
function [leftOverData, track1, track2, track3, cluster1, cluster2, cluster3, centr1, centr2, centr3] = DBSCAN(radius, minPoints, sensorsData)
    %% Algorithm- DBSCAN
    %INPUT
    % radius = int
    %minPoints = int
    ...
    leftOverDataLoc = ismember(sensorsData, clusterData(:,1:2), 'rows');
    sensorsData(leftOverDataLoc, :) = [];
    leftOverData = sensorsData;
end
